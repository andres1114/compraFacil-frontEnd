            ...
            <div class="col-xs-6 col-xs-offset-3 before-load-logo-container margin-top-1">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <hr/>
                        <div class="col-xs-12">
                            <p style="font-size: 16pt; text-align: justify">Lamentamos informarle que el usuario con el cual ha intentado acceder a esta herramienta no ha sido encontrado en la base de datos</p>
                        </div>
						<div class="row"></div>
                        <hr/>
						<center>
